...
class DiabeticPredictionView(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            data = [[request.POST.get('sex'), request.POST.get('age'), request.POST.get('high_blood_preasure'),
                request.POST.get('cholesterol'), request.POST.get('bmi'), smoker, stroke, heart_disease_or_attack,
                physical_activity, heavy_alcohol_consumption, healthcare, request.POST.get('general_health_feeling'),
                request.POST.get('mental_health_feeling'), request.POST.get('physical_health_feeling'), request.POST.get('education')]]

            # values = ["sex","age","high_blood_preasure","cholesterol","bmi","smoker","stroke","heart_disease_or_attack",
            ...
            print('prediction_proba %s' % prediction_proba)
            ...
            return redirect('/diviner/diabetic/%s' % diabetic.id, {'test': 'test1'})
